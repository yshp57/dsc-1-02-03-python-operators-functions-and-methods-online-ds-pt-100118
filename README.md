...
# Summary
In this lesson, we looked at lot. First we looked at Objects and then Python built-in methods and functions. These are objects that perform common operations on data. They help us greatly reduce the amount of code we write while also increasing the readibility, and efficiency of our code.
